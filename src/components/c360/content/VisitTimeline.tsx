      ...
      <div className="flex w-full max-w-[544px] flex-col items-center justify-center mt-[77px] max-md:max-w-full max-md:mt-10">
          ...
          <div className="flex w-full gap-[27px] justify-between flex-wrap max-md:max-w-full">
            ...
            <div className="flex flex-col items-center justify-center w-5">
              <div className="w-[15px]">
                <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/f8ae65084a7e2ec96355c94a33cf6b13ba1410fb?placeholderIfAbsent=true" className="aspect-[0.94] object-contain w-full" alt="Visit icon" />
              </div>
            ...
            <div className="flex flex-col items-center justify-center w-5">
              <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/e2c75a4b9f81ca2c85e5097cfc7693b73d4795e2?placeholderIfAbsent=true" className="aspect-[0.94] object-contain w-[15px]" alt="Visit icon" />
            </div>
            <div className="flex flex-col items-center justify-center w-5">
              <div className="w-[15px]">
                <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/e0ae278dfc8e5e9d684994bc4d042dc291200d94?placeholderIfAbsent=true" className="aspect-[0.94] object-contain w-full" alt="Visit icon" />
              </div>
            </div>
            <div className="flex w-5 shrink-0 h-5" />
            <div className="flex flex-col items-center justify-center w-5">
              <div className="w-[15px]">
                <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/5c94fc4bc4ac2d80d1d802a3f2ef1355c3d75883?placeholderIfAbsent=true" className="aspect-[0.94] object-contain w-full" alt="Visit icon" />
              </div>
            </div>
          </div>
        ...
        <div className="flex gap-4 text-xs text-[#707070] font-semibold leading-4 justify-center mt-5">
          <div className="flex items-center gap-1 whitespace-nowrap pl-px">
            <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/3673326d679db9e28af883f438ad3f6db6fc539f?placeholderIfAbsent=true" className="aspect-[0.87] object-contain w-[7px] self-stretch shrink-0 my-auto" alt="Behavioral icon" />
            <div className="self-stretch my-auto">Behavioral</div>
          </div>
          <div className="flex items-center gap-1 whitespace-nowrap pl-px">
            <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/e8bf63068961862f2dee23e86a1f06857f0a4074?placeholderIfAbsent=true" className="aspect-[1] object-contain w-2 self-stretch shrink-0 my-auto" alt="PCP icon" />
            <div className="self-stretch my-auto">PCP</div>
          </div>
          <div className="flex items-center gap-1">
            <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/8ba2bd580883333714f9e21505393a493c9a68b7?placeholderIfAbsent=true" className="aspect-[1] object-contain w-2 self-stretch shrink-0 my-auto" alt="Justine Check-ins icon" />
            <div className="self-stretch my-auto">Justine Check-ins</div>
          </div>
          <div className="flex items-center gap-1 whitespace-nowrap pl-px">
            <img src="https://cdn.builder.io/api/v1/image/assets/b5d73a9498854c6fb7efd5b51658f101/262f358a2a03d0b157d184ea261550468ed477cc?placeholderIfAbsent=true" className="aspect-[0.87] object-contain w-[7px] self-stretch shrink-0 my-auto" alt="ED icon" />
