    ...
    <aside className="flex w-full flex-col items-stretch mt-4">
      <div className="flex min-h-8 items-center gap-2 text-white font-normal whitespace-nowrap justify-center ml-4 max-md:ml-2.5">
        <button className="justify-center items-center rounded bg-[#0070DD] self-stretch flex min-h-8 gap-2 my-auto px-3 py-2">
          <span className="material-icons self-stretch text-base text-center w-4 my-auto px-px py-0.5">
            add_circle
          </span>
        ...
        <div className="flex w-full flex-col items-stretch justify-center">
          <div className="flex w-full flex-col items-stretch text-[#00509F] justify-center py-1">
            <div className="items-center bg-[#DCECF9] flex w-full gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-base font-light whitespace-nowrap text-center w-4 my-auto p-0.5">
                assignment_ind
              </span>
          ...
          <div className="flex w-full flex-col items-stretch text-base font-light leading-none justify-center py-1">
            <div className="flex w-full items-center gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-[#1F1F1F] whitespace-nowrap text-center w-4 my-auto px-0.5 py-[3px]">
                question_answer
              </span>
              ...
              <div className="self-stretch flex w-0 shrink-0 h-0.5 my-auto" />
              <span className="material-icons self-stretch text-[#707070] whitespace-nowrap text-center w-4 my-auto px-1 py-1.5">
                expand_less
              </span>
            </div>
          </div>
          <div className="flex w-full items-stretch gap-[11px] whitespace-nowrap pl-[43px] pr-5 py-2 max-md:pl-5">
            <span className="material-icons text-base text-[#1F1F1F] font-light text-center leading-none my-auto">
              history
            </span>
          ...
          <div className="flex w-full items-stretch gap-2.5 pl-[42px] pr-5 py-2 max-md:pl-5">
            <span className="material-icons text-base text-[#1F1F1F] font-light whitespace-nowrap text-center leading-none my-auto">
              fact_check
            </span>
            <div className="gap-2.5 overflow-hidden text-sm text-[#1F1F1F] font-semibold leading-none">
              Care Protocols
          ...
          <div className="flex w-full flex-col items-stretch justify-center py-1">
            <div className="flex w-full items-center gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-base text-[#1F1F1F] font-light whitespace-nowrap text-center leading-none w-4 my-auto p-0.5">
                signature
              </span>
              <div className="self-stretch gap-2.5 overflow-hidden text-sm text-[#1F1F1F] font-semibold leading-none flex-1 shrink basis-[0%] my-auto px-1">
                Consent Management
          ...
          <div className="flex w-full flex-col items-stretch whitespace-nowrap justify-center py-1">
            <div className="flex w-full items-center gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-base text-[#1F1F1F] font-light text-center leading-none w-4 my-auto px-0.5 py-[3px]">
                favorite
              </span>
              <div className="self-stretch gap-2.5 overflow-hidden text-sm text-[#1F1F1F] font-semibold leading-none flex-1 shrink basis-[0%] my-auto px-1">
                Risk
          ...
          <div className="flex w-full flex-col items-stretch whitespace-nowrap justify-center py-1">
            <div className="flex w-full items-center gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-base text-[#1F1F1F] font-light text-center leading-none w-4 my-auto p-0.5">
                receipt
              </span>
              <div className="self-stretch gap-2.5 overflow-hidden text-sm text-[#1F1F1F] font-semibold leading-none flex-1 shrink basis-[0%] my-auto px-1">
                Claims
          ...
          <div className="flex w-full flex-col items-stretch whitespace-nowrap justify-center py-1">
            <div className="flex w-full items-center gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-base text-[#2F2F2F] font-light text-center w-4 my-auto p-px">
                account_circle
              </span>
              <div className="self-stretch gap-2.5 overflow-hidden text-sm text-[#1F1F1F] font-semibold leading-none flex-1 shrink basis-[0%] my-auto px-1">
                Profile
          ...
          <div className="flex w-full flex-col items-stretch justify-center py-1">
            <div className="flex w-full items-center gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-base text-[#2F2F2F] font-light whitespace-nowrap text-center w-4 my-auto p-px">
                border_color
              </span>
              <div className="self-stretch gap-2.5 overflow-hidden text-sm text-[#1F1F1F] font-semibold leading-none flex-1 shrink basis-[0%] my-auto px-1">
                Manual Entry
          ...
          <div className="flex w-full flex-col items-stretch text-[#2F2F2F] whitespace-nowrap justify-center py-1">
            <div className="flex w-full items-center gap-1 pl-4 pr-2 py-1 rounded-[0px_16px_16px_0px]">
              <span className="material-icons self-stretch text-base font-light text-center w-4 my-auto p-0.5">
                assignment
              </span>
              <div className="self-stretch gap-2.5 overflow-hidden text-sm font-semibold leading-none flex-1 shrink basis-[0%] my-auto px-1">
                Documents
